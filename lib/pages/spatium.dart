                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Padding(
                              padding: EdgeInsets.only(right: 1.1.h, top: 1.h),
                              child: Container(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    put(
                                        context.read<Store1>().podMp3[index],
                                        context.read<Store1>().podTitle[index],
                                        context.read<Store1>().podImg[index],
                                        context.read<Store1>().podDate[index]);
                                  },
                                  child: Card(
