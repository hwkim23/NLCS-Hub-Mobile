...
class Humanities extends StatefulWidget {
  const Humanities({
    Key? key,
  }) : super(key: key);

  @override
  State<Humanities> createState() => _HumanitiesState();
}

class _HumanitiesState extends State<Humanities> {
  ...
  void fetchData() async {
    ...
    if (await webScraper
        .loadWebPage('/category/humanities/')) {
      setState(() {
  ...
  int tag = 0;
  static const subCategory = <String>["All", "Geography", "History", "Economics", "Philosophy", "Psychology", "Politics", "Cultures and Religion"];
                      ...
                      LayoutBuilder(
                          builder: (context, constraints) {
                            if (tag == 0) {
                              ...
                              filterCategory('category-geography');
                              return Container(
                                margin: EdgeInsets.only(bottom: 3.h),
                                child: ListView.builder(
                                    physics: const ClampingScrollPhysics(),
                              ...
                              filterCategory('category-history');
                              return Container(
                                margin: EdgeInsets.only(bottom: 3.h),
                                child: ListView.builder(
                                    physics: const ClampingScrollPhysics(),
                              ...
                              filterCategory('category-economics');
                              return Container(
                                margin: EdgeInsets.only(bottom: 3.h),
                                child: ListView.builder(
                                    physics: const ClampingScrollPhysics(),
                              ...
                              filterCategory('category-philosophy');
                              return Container(
                                margin: EdgeInsets.only(bottom: 3.h),
                                child: ListView.builder(
                                    physics: const ClampingScrollPhysics(),
                              ...
                              filterCategory('category-psychology');
                              return Container(
                                margin: EdgeInsets.only(bottom: 3.h),
                                child: ListView.builder(
                                    physics: const ClampingScrollPhysics(),
                              ...
                              filterCategory('category-politics');
                              return Container(
                                margin: EdgeInsets.only(bottom: 3.h),
                                child: ListView.builder(
                                    physics: const ClampingScrollPhysics(),
                              ...
                              filterCategory('category-cultures-and-religion');
                              return Container(
                                margin: EdgeInsets.only(bottom: 3.h),
                                child: ListView.builder(
                                    physics: const ClampingScrollPhysics(),
