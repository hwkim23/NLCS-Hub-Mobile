...
class BeyondTheClassroom extends StatefulWidget {
  const BeyondTheClassroom({
    Key? key,
  }) : super(key: key);

  @override
  State<BeyondTheClassroom> createState() => _BeyondTheClassroomState();
}

class _BeyondTheClassroomState extends State<BeyondTheClassroom> {
  ...
  void fetchData() async {
    if (await webScraper.loadWebPage('/category/beyondtheclassroom/')) {
      setState(() {
