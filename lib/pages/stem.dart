...
class _STEMState extends State<STEM> {
  ...
  int tag = 0;
  static const subCategory = <String>["All", "Mathematics", "Biology", "Chemistry", "Physics", "Computer Science", "Sports Science"];
                        ...
                        LayoutBuilder(
                            builder: (context, constraints) {
                              if (tag == 0) {
                                ...
                                filterCategory('category-mathematics');
                                return Container(
                                  margin: EdgeInsets.only(bottom: 3.h),
                                  child: ListView.builder(
                                      physics: const ClampingScrollPhysics(),
                                ...
                                filterCategory('category-biology');
                                return Container(
                                  margin: EdgeInsets.only(bottom: 3.h),
                                  child: ListView.builder(
                                      physics: const ClampingScrollPhysics(),
                                ...
                                filterCategory('category-chemistry');
                                return Container(
                                  margin: EdgeInsets.only(bottom: 3.h),
                                  child: ListView.builder(
                                      physics: const ClampingScrollPhysics(),
                                ...
                                filterCategory('category-physics');
                                return Container(
                                  margin: EdgeInsets.only(bottom: 3.h),
                                  child: ListView.builder(
                                      physics: const ClampingScrollPhysics(),
                                ...
                                filterCategory('category-computerscience');
                                return Container(
                                  margin: EdgeInsets.only(bottom: 3.h),
                                  child: ListView.builder(
                                      physics: const ClampingScrollPhysics(),
                                ...
                                filterCategory('category-sportsscience');
                                return Container(
                                  margin: EdgeInsets.only(bottom: 3.h),
                                  child: ListView.builder(
                                      physics: const ClampingScrollPhysics(),
